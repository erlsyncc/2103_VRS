...
public class VehicleCar extends Vehicles {
    ...
    // Constructor
    public VehicleCar(String vehicleID, String registrationNumber, String make, String model, double rentalRate, String vehicleStatus,
               String carModel, String carDescription, String plateNumber, int carCapacity, double carPrice) {
