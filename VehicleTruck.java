...
public class VehicleTruck  extends Vehicles {
    ...
    // Constructor
    public VehicleTruck(String vehicleID, String registrationNumber, String make, String model, double rentalRate, String vehicleStatus, double loadCapacity, int numOfAxles) {
